...
document.querySelectorAll('.playPauseBtn').forEach((button, index) => {
  ...
  button.addEventListener('click', () => {
    ...
    document.querySelectorAll('.audio').forEach((otherAudio, otherIndex) => {
      if (otherAudio !== audio) {
        otherAudio.pause();  // หยุดเสียงอื่นๆ
        document.querySelectorAll('.playPauseBtn')[otherIndex].textContent = 'Play';  // เปลี่ยนปุ่มเป็น Play
      }
    });

    // เล่น/หยุดเสียงตามสถานะ
    if (audio.paused) {
      audio.play();
